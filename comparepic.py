...
if __name__ == "__main__":
    ...
    runAllImageSimilaryFun("0.png", "3.png")
    runAllImageSimilaryFun("1.png", "3.png")
    runAllImageSimilaryFun("2.png", "3.png")
    # runAllImageSimilaryFun("savekey.png", "succ.png")
    # runAllImageSimilaryFun("savekey-tmp.png", "succ.png")
    # runAllImageSimilaryFun("savekey.png", "savekey-tmp.png")
    # runAllImageSimilaryFun("verify-before.png", "verify-tmp.png")
    # runAllImageSimilaryFun("errorInfo.png", "errorInfo1.png")
